...
pub mod zwlr_foreign_toplevel_manager_v1 {
    ...
    impl super::MessageGroup for Request {
        ...
        fn into_raw(self, sender_id: u32) -> Message {
            match self {
                Request::Stop => Message { sender_id, opcode: 0, args: smallvec![] },
            }
        }
...
pub mod zwlr_foreign_toplevel_handle_v1 {
    ...
    impl super::MessageGroup for Request {
        ...
        fn into_raw(self, sender_id: u32) -> Message {
            match self {
                Request::SetMaximized => Message { sender_id, opcode: 0, args: smallvec![] },
                Request::UnsetMaximized => Message { sender_id, opcode: 1, args: smallvec![] },
                Request::SetMinimized => Message { sender_id, opcode: 2, args: smallvec![] },
                Request::UnsetMinimized => Message { sender_id, opcode: 3, args: smallvec![] },
                Request::Activate { seat } => Message {
                    sender_id,
                    opcode: 4,
                    args: smallvec![Argument::Object(seat.as_ref().id()),],
                },
                Request::Close => Message { sender_id, opcode: 5, args: smallvec![] },
                Request::SetRectangle { surface, x, y, width, height } => Message {
                    sender_id,
                    opcode: 6,
                    args: smallvec![
                ...
                Request::Destroy => Message { sender_id, opcode: 7, args: smallvec![] },
                Request::SetFullscreen { output } => Message {
                    sender_id,
                    opcode: 8,
                    args: smallvec![Argument::Object(output.map(|o| o.as_ref().id()).unwrap_or(0)),],
                },
                Request::UnsetFullscreen => Message { sender_id, opcode: 9, args: smallvec![] },
            }
        }
        unsafe fn from_raw_c(
            obj: *mut ::std::os::raw::c_void,
            ...
            F: FnOnce(u32, &mut [wl_argument]) -> T,
        {
            match self {
                ...
                Request::SetRectangle { surface, x, y, width, height } => {
    ...
    impl super::MessageGroup for Event {
        const MESSAGES: &'static [super::MessageDesc] = &[
            ...
            super::MessageDesc { name: "closed", since: 1, signature: &[], destructor: false },
            super::MessageDesc {
                name: "parent",
                since: 3,
                signature: &[super::ArgumentType::Object],
                ...
                7 => {
                    ...
                    Ok(Event::Parent {
                        parent: if _args[0].o.is_null() {
                            ...
                            Some (Proxy :: < super :: zwlr_foreign_toplevel_handle_v1 :: ZwlrForeignToplevelHandleV1 > :: from_c_ptr (_args [0] . o as * mut _ ,) . into ())
                        },
                    })
                }
                _ => return Err(()),
    ...
    impl ZwlrForeignToplevelHandleV1 {
        ...
        pub fn set_rectangle(
            ...
            let msg = Request::SetRectangle { surface: surface.clone(), x, y, width, height };
            self.0.send::<AnonymousObject>(msg, None);
        }
    ...
    static mut zwlr_foreign_toplevel_handle_v1_events_output_leave_types: [*const wl_interface; 1] =
        [unsafe { &super::wl_output::wl_output_interface as *const wl_interface }];
    static mut zwlr_foreign_toplevel_handle_v1_events_parent_types: [*const wl_interface; 1] =
        [unsafe {
            &super::zwlr_foreign_toplevel_handle_v1::zwlr_foreign_toplevel_handle_v1_interface
                as *const wl_interface
        }];
