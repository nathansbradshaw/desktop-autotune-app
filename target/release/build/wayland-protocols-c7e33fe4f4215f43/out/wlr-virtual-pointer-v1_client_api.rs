...
pub mod zwlr_virtual_pointer_v1 {
    ...
    pub enum Request {
        ...
        MotionAbsolute { time: u32, x: u32, y: u32, x_extent: u32, y_extent: u32 },
        #[doc = "button event\n\nA button was pressed or released."]
        Button { time: u32, button: u32, state: super::wl_pointer::ButtonState },
        #[doc = "axis event\n\nScroll and other axis requests."]
        Axis { time: u32, axis: super::wl_pointer::Axis, value: f64 },
        ...
        AxisDiscrete { time: u32, axis: super::wl_pointer::Axis, value: f64, discrete: i32 },
    ...
    impl super::MessageGroup for Request {
        ...
        fn into_raw(self, sender_id: u32) -> Message {
            match self {
                ...
                Request::MotionAbsolute { time, x, y, x_extent, y_extent } => Message {
                    sender_id,
                    opcode: 1,
                    args: smallvec![
                        Argument::Uint(time),
                ...
                Request::Frame => Message { sender_id, opcode: 4, args: smallvec![] },
                ...
                Request::AxisDiscrete { time, axis, value, discrete } => Message {
                    sender_id,
                    opcode: 7,
                    args: smallvec![
                        Argument::Uint(time),
                ...
                Request::Destroy => Message { sender_id, opcode: 8, args: smallvec![] },
            }
        }
    ...
    impl ZwlrVirtualPointerV1 {
        ...
        pub fn motion(&self, time: u32, dx: f64, dy: f64) -> () {
            let msg = Request::Motion { time, dx, dy };
        ...
        pub fn axis_source(&self, axis_source: super::wl_pointer::AxisSource) -> () {
            let msg = Request::AxisSource { axis_source };
            self.0.send::<AnonymousObject>(msg, None);
        }
        #[doc = "axis stop event\n\nStop notification for scroll and other axes."]
        pub fn axis_stop(&self, time: u32, axis: super::wl_pointer::Axis) -> () {
            let msg = Request::AxisStop { time, axis };
            self.0.send::<AnonymousObject>(msg, None);
        }
        #[doc = "axis click event\n\nDiscrete step information for scroll and other axes.\n\nThis event allows the client to extend data normally sent using the axis\nevent with discrete value."]
        pub fn axis_discrete(
            ...
            let msg = Request::AxisDiscrete { time, axis, value, discrete };
            self.0.send::<AnonymousObject>(msg, None);
        }
...
pub mod zwlr_virtual_pointer_manager_v1 {
    ...
    impl ZwlrVirtualPointerManagerV1 {
        ...
        pub fn create_virtual_pointer(
            ...
            let msg = Request::CreateVirtualPointer { seat: seat.map(|o| o.clone()) };
