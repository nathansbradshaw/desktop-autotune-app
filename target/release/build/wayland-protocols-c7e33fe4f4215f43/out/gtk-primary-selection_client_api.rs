...
pub mod gtk_primary_selection_device {
    ...
    pub enum Event {
        ...
        DataOffer { offer: Main<super::gtk_primary_selection_offer::GtkPrimarySelectionOffer> },
        ...
        Selection { id: Option<super::gtk_primary_selection_offer::GtkPrimarySelectionOffer> },
    }
    impl super::MessageGroup for Event {
        const MESSAGES: &'static [super::MessageDesc] = &[
            super::MessageDesc {
