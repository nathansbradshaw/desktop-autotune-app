...
pub mod zwp_tablet_tool_v2 {
    ...
    impl super::MessageGroup for Event {
        const MESSAGES: &'static [super::MessageDesc] = &[
            ...
            super::MessageDesc { name: "removed", since: 1, signature: &[], destructor: false },
            super::MessageDesc {
                name: "proximity_in",
                since: 1,
                signature: &[
            ...
            super::MessageDesc { name: "up", since: 1, signature: &[], destructor: false },
            super::MessageDesc {
                name: "motion",
                since: 1,
        ...
        unsafe fn from_raw_c(
            ...
            match opcode {
                0 => {
                    let _args = ::std::slice::from_raw_parts(args, 1);
                    Ok(Event::Type { tool_type: Type::from_raw(_args[0].u).ok_or(())? })
                }
                1 => {
                ...
                14 => {
                    let _args = ::std::slice::from_raw_parts(args, 1);
                    Ok(Event::Rotation { degrees: (_args[0].f as f64) / 256. })
                }
                15 => {
                    let _args = ::std::slice::from_raw_parts(args, 1);
                ...
                16 => {
                    let _args = ::std::slice::from_raw_parts(args, 2);
                    Ok(Event::Wheel { degrees: (_args[0].f as f64) / 256., clicks: _args[1].i })
                }
                17 => {
                    let _args = ::std::slice::from_raw_parts(args, 3);
                    Ok(Event::Button {
    ...
    impl super::MessageGroup for Event {
        ...
        unsafe fn from_raw_c(
            ...
            match opcode {
                ...
                1 => {
                    let _args = ::std::slice::from_raw_parts(args, 2);
                    Ok(Event::Id { vid: _args[0].u, pid: _args[1].u })
                }
                2 => {
                    let _args = ::std::slice::from_raw_parts(args, 1);
                    Ok(Event::Path {
...
pub mod zwp_tablet_pad_ring_v2 {
    ...
    impl super::MessageGroup for Event {
        ...
        unsafe fn from_raw_c(
            ...
            match opcode {
                0 => {
                    let _args = ::std::slice::from_raw_parts(args, 1);
                    Ok(Event::Source { source: Source::from_raw(_args[0].u).ok_or(())? })
                }
                1 => {
                    let _args = ::std::slice::from_raw_parts(args, 1);
                    Ok(Event::Angle { degrees: (_args[0].f as f64) / 256. })
                }
                2 => Ok(Event::Stop),
                3 => {
                    let _args = ::std::slice::from_raw_parts(args, 1);
    ...
    impl ZwpTabletPadRingV2 {
        ...
        pub fn set_feedback(&self, description: String, serial: u32) -> () {
            let msg = Request::SetFeedback { description, serial };
            self.0.send::<AnonymousObject>(msg, None);
        }
        #[doc = "destroy the ring object\n\nThis destroys the client's resource for this ring object.\n\nThis is a destructor, you cannot send requests to this object any longer once this method is called."]
        pub fn destroy(&self) -> () {
...
pub mod zwp_tablet_pad_group_v2 {
    ...
    pub enum Event {
        ...
        Ring { ring: Main<super::zwp_tablet_pad_ring_v2::ZwpTabletPadRingV2> },
        #[doc = "strip announced\n\nSent on wp_tablet_pad initialization to announce available strips.\nOne event is sent for each strip available on this pad group.\n\nThis event is sent in the initial burst of events before the\nwp_tablet_pad_group.done event."]
        Strip { strip: Main<super::zwp_tablet_pad_strip_v2::ZwpTabletPadStripV2> },
    ...
    impl super::MessageGroup for Event {
        ...
        unsafe fn from_raw_c(
            ...
            match opcode {
                ...
                5 => {
                    let _args = ::std::slice::from_raw_parts(args, 3);
                    Ok(Event::ModeSwitch { time: _args[0].u, serial: _args[1].u, mode: _args[2].u })
                }
                _ => return Err(()),
            }
        }
...
pub mod zwp_tablet_pad_v2 {
    ...
    pub enum Event {
        ...
        Group { pad_group: Main<super::zwp_tablet_pad_group_v2::ZwpTabletPadGroupV2> },
    ...
    impl ZwpTabletPadV2 {
        ...
        pub fn set_feedback(&self, button: u32, description: String, serial: u32) -> () {
            let msg = Request::SetFeedback { button, description, serial };
            self.0.send::<AnonymousObject>(msg, None);
        }
        #[doc = "destroy the pad object\n\nDestroy the wp_tablet_pad object. Objects created from this object\nare unaffected and should be destroyed separately.\n\nThis is a destructor, you cannot send requests to this object any longer once this method is called."]
        pub fn destroy(&self) -> () {
