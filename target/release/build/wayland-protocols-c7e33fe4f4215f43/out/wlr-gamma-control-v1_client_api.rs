...
pub mod zwlr_gamma_control_manager_v1 {
    ...
    impl super::MessageGroup for Request {
        ...
        fn child<Meta: ObjectMetadata>(
            ...
            match opcode {
                0 => Some(
                    Object::from_interface::<super::zwlr_gamma_control_v1::ZwlrGammaControlV1>(
                        version,
                        meta.child(),
                    ),
                ),
...
pub mod zwlr_gamma_control_v1 {
    ...
    impl super::MessageGroup for Request {
        ...
        fn into_raw(self, sender_id: u32) -> Message {
            match self {
                Request::SetGamma { fd } => {
                    Message { sender_id, opcode: 0, args: smallvec![Argument::Fd(fd),] }
                }
                Request::Destroy => Message { sender_id, opcode: 1, args: smallvec![] },
            }
        }
