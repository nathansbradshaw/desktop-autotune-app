...
pub mod zxdg_output_manager_v1 {
    ...
    impl super::MessageGroup for Request {
        ...
        fn child<Meta: ObjectMetadata>(
            ...
            match opcode {
                1 => Some(Object::from_interface::<super::zxdg_output_v1::ZxdgOutputV1>(
                    version,
                    meta.child(),
                )),
                _ => None,
    ...
    impl ZxdgOutputManagerV1 {
        ...
        pub fn get_xdg_output(
            ...
            let msg = Request::GetXdgOutput { output: output.clone() };
        ...
        unsafe fn from_raw_c(
            ...
            match opcode {
                0 => {
                    ...
                    Ok(Event::LogicalPosition { x: _args[0].i, y: _args[1].i })
                }
                1 => {
                    let _args = ::std::slice::from_raw_parts(args, 2);
                    Ok(Event::LogicalSize { width: _args[0].i, height: _args[1].i })
                }
                2 => Ok(Event::Done),
                3 => {
