...
pub mod zwp_input_method_v2 {
    ...
    pub enum Request {
        ...
        GetInputPopupSurface { surface: super::wl_surface::WlSurface },
    ...
    impl super::MessageGroup for Request {
        ...
        fn into_raw(self, sender_id: u32) -> Message {
            match self {
                ...
                Request::SetPreeditString { text, cursor_begin, cursor_end } => Message {
                    sender_id,
                    opcode: 1,
                    args: smallvec![
                ...
                Request::DeleteSurroundingText { before_length, after_length } => Message {
                    sender_id,
                    opcode: 2,
                ...
                Request::GrabKeyboard {} => {
                    Message { sender_id, opcode: 5, args: smallvec![Argument::NewId(0),] }
                }
                Request::Destroy => Message { sender_id, opcode: 6, args: smallvec![] },
            }
        }
            ...
            F: FnOnce(u32, &mut [wl_argument]) -> T,
        {
            match self {
                ...
                Request::SetPreeditString { text, cursor_begin, cursor_end } => {
                ...
                Request::DeleteSurroundingText { before_length, after_length } => {
    ...
    pub enum Event {
        ...
        TextChangeCause { cause: super::zwp_text_input_v3::ChangeCause },
    ...
    impl super::MessageGroup for Event {
        const MESSAGES: &'static [super::MessageDesc] = &[
            super::MessageDesc { name: "activate", since: 1, signature: &[], destructor: false },
            super::MessageDesc { name: "deactivate", since: 1, signature: &[], destructor: false },
            super::MessageDesc {
            ...
            super::MessageDesc { name: "done", since: 1, signature: &[], destructor: false },
            super::MessageDesc { name: "unavailable", since: 1, signature: &[], destructor: false },
        ];
        type Map = super::ProxyMap;
        fn is_destructor(&self) -> bool {
            match *self {
    ...
    impl ZwpInputMethodV2 {
        ...
        pub fn get_input_popup_surface(
            ...
            let msg = Request::GetInputPopupSurface { surface: surface.clone() };
...
pub mod zwp_input_popup_surface_v2 {
    ...
    pub enum Event {
        ...
        TextInputRectangle { x: i32, y: i32, width: i32, height: i32 },
    }
    impl super::MessageGroup for Event {
...
pub mod zwp_input_method_keyboard_grab_v2 {
    ...
    pub enum Event {
        ...
        Key { serial: u32, time: u32, key: u32, state: super::wl_keyboard::KeyState },
...
pub mod zwp_input_method_manager_v2 {
    ...
    impl super::MessageGroup for Request {
        ...
        fn child<Meta: ObjectMetadata>(
            ...
            match opcode {
                0 => Some(Object::from_interface::<super::zwp_input_method_v2::ZwpInputMethodV2>(
                    version,
                    meta.child(),
                )),
                _ => None,
    ...
    static mut zwp_input_method_manager_v2_requests_get_input_method_types: [*const wl_interface;
        2] = [unsafe { &super::wl_seat::wl_seat_interface as *const wl_interface }, unsafe {
