...
pub mod zwp_pointer_constraints_v1 {
    ...
    impl super::MessageGroup for Request {
        ...
        fn child<Meta: ObjectMetadata>(
            ...
            match opcode {
                1 => Some(
                    Object::from_interface::<super::zwp_locked_pointer_v1::ZwpLockedPointerV1>(
                        version,
                        meta.child(),
                    ),
                ),
        ...
        fn into_raw(self, sender_id: u32) -> Message {
            match self {
                ...
                Request::LockPointer { surface, pointer, region, lifetime } => Message {
                    sender_id,
                    opcode: 1,
                    args: smallvec![
                        Argument::NewId(0),
                        ...
                        Argument::Uint(lifetime.to_raw()),
                    ],
                },
                Request::ConfinePointer { surface, pointer, region, lifetime } => Message {
                    sender_id,
                    opcode: 2,
                    args: smallvec![
                        Argument::NewId(0),
            ...
            F: FnOnce(u32, &mut [wl_argument]) -> T,
        {
            match self {
                ...
                Request::LockPointer { surface, pointer, region, lifetime } => {
                ...
                Request::ConfinePointer { surface, pointer, region, lifetime } => {
                    let mut _args_array: [wl_argument; 5] = unsafe { ::std::mem::zeroed() };
                    _args_array[0].o = ::std::ptr::null_mut() as *mut _;
                    _args_array[1].o = surface.as_ref().c_ptr() as *mut _;
                    _args_array[2].o = pointer.as_ref().c_ptr() as *mut _;
...
pub mod zwp_locked_pointer_v1 {
    ...
    impl super::MessageGroup for Event {
        const MESSAGES: &'static [super::MessageDesc] = &[
            super::MessageDesc { name: "locked", since: 1, signature: &[], destructor: false },
            super::MessageDesc { name: "unlocked", since: 1, signature: &[], destructor: false },
        ];
        type Map = super::ProxyMap;
        fn is_destructor(&self) -> bool {
            match *self {
    ...
    impl ZwpLockedPointerV1 {
        ...
        pub fn set_cursor_position_hint(&self, surface_x: f64, surface_y: f64) -> () {
            let msg = Request::SetCursorPositionHint { surface_x, surface_y };
            self.0.send::<AnonymousObject>(msg, None);
        }
        #[doc = "set a new lock region\n\nSet a new region used to lock the pointer.\n\nThe new lock region is double-buffered. The new lock region will\nonly take effect when the associated surface gets its pending state\napplied. See wl_surface.commit for details.\n\nFor details about the lock region, see wp_locked_pointer."]
        pub fn set_region(&self, region: Option<&super::wl_region::WlRegion>) -> () {
            let msg = Request::SetRegion { region: region.map(|o| o.clone()) };
            self.0.send::<AnonymousObject>(msg, None);
        }
    }
    #[doc = r" The minimal object version supporting this request"]
...
pub mod zwp_confined_pointer_v1 {
    ...
    impl super::MessageGroup for Event {
        const MESSAGES: &'static [super::MessageDesc] = &[
            super::MessageDesc { name: "confined", since: 1, signature: &[], destructor: false },
            super::MessageDesc { name: "unconfined", since: 1, signature: &[], destructor: false },
        ];
        type Map = super::ProxyMap;
        fn is_destructor(&self) -> bool {
            match *self {
