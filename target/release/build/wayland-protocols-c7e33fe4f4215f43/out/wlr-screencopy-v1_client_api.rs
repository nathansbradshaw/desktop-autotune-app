...
pub mod zwlr_screencopy_manager_v1 {
    ...
    pub enum Request {
        ...
        CaptureOutput { overlay_cursor: i32, output: super::wl_output::WlOutput },
    ...
    impl super::MessageGroup for Request {
        ...
        fn into_raw(self, sender_id: u32) -> Message {
            match self {
                ...
                Request::CaptureOutputRegion { overlay_cursor, output, x, y, width, height } => {
                    Message {
                        sender_id,
                        opcode: 1,
                        args: smallvec![
    ...
    impl ZwlrScreencopyManagerV1 {
        ...
        pub fn capture_output(
            ...
            let msg = Request::CaptureOutput { overlay_cursor, output: output.clone() };
...
pub mod zwlr_screencopy_frame_v1 {
    ...
    pub enum Event {
        ...
        Buffer { format: super::wl_shm::Format, width: u32, height: u32, stride: u32 },
    ...
    impl super::MessageGroup for Event {
        const MESSAGES: &'static [super::MessageDesc] = &[
            ...
            super::MessageDesc { name: "buffer_done", since: 3, signature: &[], destructor: false },
        ];
        type Map = super::ProxyMap;
        fn is_destructor(&self) -> bool {
            match *self {
        ...
        unsafe fn from_raw_c(
            ...
            match opcode {
                ...
                1 => {
                    ...
                    Ok(Event::Flags { flags: Flags::from_raw(_args[0].u).ok_or(())? })
                }
                2 => {
