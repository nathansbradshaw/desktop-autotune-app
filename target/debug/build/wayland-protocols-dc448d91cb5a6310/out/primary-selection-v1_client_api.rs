...
pub mod zwp_primary_selection_device_v1 {
    ...
    pub enum Event {
        ...
        DataOffer { offer: Main<super::zwp_primary_selection_offer_v1::ZwpPrimarySelectionOfferV1> },
        ...
        Selection { id: Option<super::zwp_primary_selection_offer_v1::ZwpPrimarySelectionOfferV1> },
    }
    impl super::MessageGroup for Event {
        const MESSAGES: &'static [super::MessageDesc] = &[
            super::MessageDesc {
