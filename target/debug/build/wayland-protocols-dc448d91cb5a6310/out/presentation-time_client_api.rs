...
pub mod wp_presentation {
    ...
    impl WpPresentation {
        ...
        pub fn feedback(
            ...
            let msg = Request::Feedback { surface: surface.clone() };
...
pub mod wp_presentation_feedback {
    ...
    impl super::MessageGroup for Event {
        const MESSAGES: &'static [super::MessageDesc] = &[
            ...
            super::MessageDesc { name: "discarded", since: 1, signature: &[], destructor: false },
        ];
        type Map = super::ProxyMap;
        fn is_destructor(&self) -> bool {
            match *self {
            ...
            match opcode {
                ...
                1 => {
                    ...
                    Ok(Event::Presented {
                        ...
                        seq_hi: _args[4].u,
                        seq_lo: _args[5].u,
                        flags: Kind::from_raw(_args[6].u).ok_or(())?,
                    })
                }
                2 => Ok(Event::Discarded),
                _ => return Err(()),
