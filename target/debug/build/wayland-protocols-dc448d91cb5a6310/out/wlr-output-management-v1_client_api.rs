...
pub mod zwlr_output_manager_v1 {
    ...
    impl super::MessageGroup for Request {
        const MESSAGES: &'static [super::MessageDesc] = &[
            ...
            super::MessageDesc { name: "stop", since: 1, signature: &[], destructor: false },
        ];
        ...
        fn into_raw(self, sender_id: u32) -> Message {
            match self {
                ...
                Request::Stop => Message { sender_id, opcode: 1, args: smallvec![] },
            }
        }
    ...
    pub enum Event {
        ...
        Head { head: Main<super::zwlr_output_head_v1::ZwlrOutputHeadV1> },
    ...
    impl super::MessageGroup for Event {
        const MESSAGES: &'static [super::MessageDesc] = &[
            ...
            super::MessageDesc { name: "finished", since: 1, signature: &[], destructor: false },
        ];
        type Map = super::ProxyMap;
        fn is_destructor(&self) -> bool {
            match *self {
    ...
    impl ZwlrOutputManagerV1 {
        ...
        pub fn create_configuration(
            ...
            let msg = Request::CreateConfiguration { serial };
...
pub mod zwlr_output_head_v1 {
    ...
    pub enum Event {
        ...
        Mode { mode: Main<super::zwlr_output_mode_v1::ZwlrOutputModeV1> },
        #[doc = "head is enabled or disabled\n\nThis event describes whether the head is enabled. A disabled head is not\nmapped to a region of the global compositor space.\n\nWhen a head is disabled, some properties (current_mode, position,\ntransform and scale) are irrelevant."]
        Enabled { enabled: i32 },
        #[doc = "current mode\n\nThis event describes the mode currently in use for this head. It is only\nsent if the output is enabled."]
        CurrentMode { mode: super::zwlr_output_mode_v1::ZwlrOutputModeV1 },
        ...
        unsafe fn from_raw_c(
            ...
            match opcode {
                ...
                2 => {
                    ...
                    Ok(Event::PhysicalSize { width: _args[0].i, height: _args[1].i })
                }
                3 => {
                    let _args = ::std::slice::from_raw_parts(args, 1);
                    Ok(Event::Mode {
                ...
                6 => {
                    let _args = ::std::slice::from_raw_parts(args, 2);
                    Ok(Event::Position { x: _args[0].i, y: _args[1].i })
                }
                7 => {
                    let _args = ::std::slice::from_raw_parts(args, 1);
                    Ok(Event::Transform {
                ...
                8 => {
                    let _args = ::std::slice::from_raw_parts(args, 1);
                    Ok(Event::Scale { scale: (_args[0].f as f64) / 256. })
                }
                9 => Ok(Event::Finished),
                10 => {
                    let _args = ::std::slice::from_raw_parts(args, 1);
...
pub mod zwlr_output_mode_v1 {
    ...
    impl super::MessageGroup for Event {
        const MESSAGES: &'static [super::MessageDesc] = &[
            ...
            super::MessageDesc { name: "preferred", since: 1, signature: &[], destructor: false },
            super::MessageDesc { name: "finished", since: 1, signature: &[], destructor: false },
        ];
        type Map = super::ProxyMap;
        fn is_destructor(&self) -> bool {
        ...
        unsafe fn from_raw_c(
            ...
            match opcode {
                0 => {
                    let _args = ::std::slice::from_raw_parts(args, 2);
                    Ok(Event::Size { width: _args[0].i, height: _args[1].i })
                }
                1 => {
                    let _args = ::std::slice::from_raw_parts(args, 1);
...
pub mod zwlr_output_configuration_v1 {
    ...
    pub enum Request {
        ...
        EnableHead { head: super::zwlr_output_head_v1::ZwlrOutputHeadV1 },
        #[doc = "disable a head\n\nDisable a head."]
        DisableHead { head: super::zwlr_output_head_v1::ZwlrOutputHeadV1 },
    ...
    impl super::MessageGroup for Request {
        const MESSAGES: &'static [super::MessageDesc] = &[
            ...
            super::MessageDesc { name: "apply", since: 1, signature: &[], destructor: false },
            super::MessageDesc { name: "test", since: 1, signature: &[], destructor: false },
        ...
        fn into_raw(self, sender_id: u32) -> Message {
            match self {
                ...
                Request::Apply => Message { sender_id, opcode: 2, args: smallvec![] },
                Request::Test => Message { sender_id, opcode: 3, args: smallvec![] },
                Request::Destroy => Message { sender_id, opcode: 4, args: smallvec![] },
            }
        }
        unsafe fn from_raw_c(
            obj: *mut ::std::os::raw::c_void,
    ...
    impl super::MessageGroup for Event {
        const MESSAGES: &'static [super::MessageDesc] = &[
            super::MessageDesc { name: "succeeded", since: 1, signature: &[], destructor: false },
            super::MessageDesc { name: "failed", since: 1, signature: &[], destructor: false },
...
pub mod zwlr_output_configuration_head_v1 {
    ...
    pub enum Request {
        ...
        SetMode { mode: super::zwlr_output_mode_v1::ZwlrOutputModeV1 },
    ...
    impl ZwlrOutputConfigurationHeadV1 {
        ...
        pub fn set_custom_mode(&self, width: i32, height: i32, refresh: i32) -> () {
            let msg = Request::SetCustomMode { width, height, refresh };
            self.0.send::<AnonymousObject>(msg, None);
        }
        #[doc = "set the position\n\nThis request sets the head's position in the global compositor space."]
        ...
        pub fn set_transform(&self, transform: super::wl_output::Transform) -> () {
            let msg = Request::SetTransform { transform };
            self.0.send::<AnonymousObject>(msg, None);
        }
        #[doc = "set the scale\n\nThis request sets the head's scale."]
        pub fn set_scale(&self, scale: f64) -> () {
            let msg = Request::SetScale { scale };
            self.0.send::<AnonymousObject>(msg, None);
        }
    }
    #[doc = r" The minimal object version supporting this request"]
