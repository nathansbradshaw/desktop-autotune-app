...
pub mod zwp_pointer_gestures_v1 {
    ...
    impl ZwpPointerGesturesV1 {
        ...
        pub fn get_swipe_gesture(
            ...
            let msg = Request::GetSwipeGesture { pointer: pointer.clone() };
        ...
        pub fn get_pinch_gesture(
            ...
            let msg = Request::GetPinchGesture { pointer: pointer.clone() };
            self.0.send(msg, None).unwrap()
        }
...
pub mod zwp_pointer_gesture_swipe_v1 {
    ...
    pub enum Event {
        ...
        Begin { serial: u32, time: u32, surface: super::wl_surface::WlSurface, fingers: u32 },
    ...
    impl super::MessageGroup for Event {
        ...
        unsafe fn from_raw_c(
            ...
            match opcode {
                ...
                2 => {
                    let _args = ::std::slice::from_raw_parts(args, 3);
                    Ok(Event::End { serial: _args[0].u, time: _args[1].u, cancelled: _args[2].i })
                }
                _ => return Err(()),
            }
        }
