...
pub mod zwlr_data_control_device_v1 {
    ...
    pub enum Request {
        ...
        SetSelection { source: Option<super::zwlr_data_control_source_v1::ZwlrDataControlSourceV1> },
    ...
    pub enum Event {
        ...
        DataOffer { id: Main<super::zwlr_data_control_offer_v1::ZwlrDataControlOfferV1> },
        ...
        Selection { id: Option<super::zwlr_data_control_offer_v1::ZwlrDataControlOfferV1> },
        ...
        PrimarySelection { id: Option<super::zwlr_data_control_offer_v1::ZwlrDataControlOfferV1> },
    }
    impl super::MessageGroup for Event {
        const MESSAGES: &'static [super::MessageDesc] = &[
            super::MessageDesc {
    ...
    impl ZwlrDataControlDeviceV1 {
        ...
        pub fn set_selection(
            ...
            let msg = Request::SetSelection { source: source.map(|o| o.clone()) };
            self.0.send::<AnonymousObject>(msg, None);
        }
        #[doc = "destroy this data device\n\nDestroys the data device object.\n\nThis is a destructor, you cannot send requests to this object any longer once this method is called."]
        pub fn destroy(&self) -> () {
        ...
        pub fn set_primary_selection(
            ...
            let msg = Request::SetPrimarySelection { source: source.map(|o| o.clone()) };
            self.0.send::<AnonymousObject>(msg, None);
        }
    }
    #[doc = r" The minimal object version supporting this request"]
