...
pub mod zwp_keyboard_shortcuts_inhibit_manager_v1 {
    ...
    pub enum Request {
        ...
        InhibitShortcuts { surface: super::wl_surface::WlSurface, seat: super::wl_seat::WlSeat },
    }
    ...
    impl ZwpKeyboardShortcutsInhibitManagerV1 {
        ...
        {
            let msg = Request::InhibitShortcuts { surface: surface.clone(), seat: seat.clone() };
...
pub mod zwp_keyboard_shortcuts_inhibitor_v1 {
    ...
    impl super::MessageGroup for Event {
        const MESSAGES: &'static [super::MessageDesc] = &[
            super::MessageDesc { name: "active", since: 1, signature: &[], destructor: false },
            super::MessageDesc { name: "inactive", since: 1, signature: &[], destructor: false },
        ];
        type Map = super::ProxyMap;
        fn is_destructor(&self) -> bool {
            match *self {
