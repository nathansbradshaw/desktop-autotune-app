...
pub mod zxdg_decoration_manager_v1 {
    ...
    impl ZxdgDecorationManagerV1 {
        ...
        pub fn get_toplevel_decoration(
            ...
            let msg = Request::GetToplevelDecoration { toplevel: toplevel.clone() };
...
pub mod zxdg_toplevel_decoration_v1 {
    ...
    impl super::MessageGroup for Request {
        const MESSAGES: &'static [super::MessageDesc] = &[
            ...
            super::MessageDesc { name: "unset_mode", since: 1, signature: &[], destructor: false },
        ];
        type Map = super::ProxyMap;
        fn is_destructor(&self) -> bool {
            match *self {
        ...
        fn into_raw(self, sender_id: u32) -> Message {
            match self {
                ...
                Request::UnsetMode => Message { sender_id, opcode: 2, args: smallvec![] },
            }
        }
        unsafe fn from_raw_c(
            obj: *mut ::std::os::raw::c_void,
        ...
        unsafe fn from_raw_c(
            ...
            match opcode {
                0 => {
                    ...
                    Ok(Event::Configure { mode: Mode::from_raw(_args[0].u).ok_or(())? })
                }
                _ => return Err(()),
            }
        }
