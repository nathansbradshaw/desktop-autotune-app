...
pub mod org_kde_kwin_server_decoration_manager {
    ...
    pub enum Request {
        ...
        Create { surface: super::wl_surface::WlSurface },
    }
        ...
        unsafe fn from_raw_c(
            ...
            match opcode {
                0 => {
                    ...
                    Ok(Event::DefaultMode { mode: Mode::from_raw(_args[0].u).ok_or(())? })
                }
                _ => return Err(()),
            }
        }
    ...
    impl OrgKdeKwinServerDecorationManager {
        ...
        pub fn create(
            ...
            let msg = Request::Create { surface: surface.clone() };
...
pub mod org_kde_kwin_server_decoration {
    ...
    impl OrgKdeKwinServerDecoration {
        ...
        pub fn request_mode(&self, mode: Mode) -> () {
            let msg = Request::RequestMode { mode };
            self.0.send::<AnonymousObject>(msg, None);
        }
    }
    #[doc = r" The minimal object version supporting this request"]
